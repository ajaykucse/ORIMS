...
<div class="panel panel-default">
 	<div class="panel-headin">
 		 <div class="well well-sm" style="color: #333;background-color: #4D545D;border-color: #ddd;">
 		 	<h3>Add New Goverment Office</h3>
 		 </div>
 	</div>
 	<div class="pull-left">
 		<form class="navbar-form" role="search">
 			<button type="button" class="btn btn-primary" id="gov_office">
	...
	<div class="pull-right">
 	...
 	<div class="panel-body">
 		@include('admin.office.gov_office.insertGovOffice')
 		@if(isset($govOffice))
...
<script type="text/javascript">
	$('#gov_office').on('click',function(){
		$('#insert_gov_office').modal('show');
	})
</script>
<script type="text/javascript">
