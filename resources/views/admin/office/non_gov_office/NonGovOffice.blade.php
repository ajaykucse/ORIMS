...
<html lang="en">
<head>
  <title>Non-Goverment Office</title>
  <meta charset="utf-8">
...
<div class="panel panel-default">
 	<div class="panel-headin">
 		 <div class="well well-sm" style="color: #333;background-color: #4D545D;border-color: #ddd;">
 		 	<h3>Add New Non-Goverment Office</h3>
 		 </div>
 	</div>
 	<div class="pull-left">
 		<form class="navbar-form" role="search">
 			<button type="button" class="btn btn-primary" id="Nongov_office">
	...
	<div class="pull-right">
 	...
 	<div class="panel-body">
 		@include('admin.office.non_gov_office.insertNonGovOffice')
 		@if(isset($da))
...
<script type="text/javascript">
	$('#Nongov_office').on('click',function(){
		$('#insert_Nongov_office').modal('show');
	})
</script>
<script type="text/javascript">
