...
<section class="no-padding" id="">
    <p class="webedesign">WE DESIGN YOUR WEBSITE<br></p><p class="health-care-txt">BLOOD-BANK</p>

    <div class="container-fluid" id="search-health-care">
    <form class="form-inline" role="search" action="{{ url('http://localhost:8000/bloodbank') }}" method="get" style="margin-left: 75px;">
        ...
        <img src="img\bloodbanksoftware.png"/ alt='missing'>
</section>
 <br>
<section class="no-padding" id="">
    <style>
 ...
 <div class="container">
    ...
    <div class="row">
            <div class="panel panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">{{$bloodbank->name}}</h3>
                </div>
                <div class="panel-body">
                     <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <span class="glyphicon glyphicon-list"></span> Available Blood
                                        </div>
                                        <div class="panel-body">
                                            <ul class="list-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <div id="map"></div>
                                <input type="hidden" name="lat" value="{{$bloodbank->lat}}" id="lat"> 
                                <input type="hidden" name="long" value="{{$bloodbank->long}}" id="long">
                            <script>
                                function initMap() {
                            ...
                            <h3><a href="{{$bloodbank->url}}" target="_blank" style="color:#367AC0;">{{$bloodbank->name}}</a></h3>
                           <center><h4 class="glyphicon glyphicon-earphone" aria-hidden="true">
                                <a class="mobilesOnly" href="tel:{{$bloodbank->contact}}" style="color:#367AC0;">{{$bloodbank->contact}}</a>
                            </h4>
                            <h4 style="color:#367AC0;">Address: {{$bloodbank->address}}</h4>  </center>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row" id="row">
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">doctors of {{$bloodbank->name}}</h3>
 ...
 <div class="row">
    <div class="col-md-12">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">ambulance of {{$bloodbank->name}}</h3>
        ...
        <center>
            <tr>
                <td colspan="2">
                    <div class="pagination">{!! str_replace('/?', '?', $bloodbanks->appends(['s' => $s])->render()) !!}</div>      
                </td>
            </tr>
        </center>
    @endforeach
